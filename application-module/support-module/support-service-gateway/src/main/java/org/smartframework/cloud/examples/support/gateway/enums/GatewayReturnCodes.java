...
public enum GatewayReturnCodes implements IBaseReturnCodes {
     ...
     * 当前用户暂未登陆，获取userId失败
     */
    GET_USERID_FAIL("400007"),
    /**
     * 未获取到登陆缓存信息
     */
    LOGIN_CACHE_MISSING("400008"),
    /**
     * 请求时间戳为空
     */
    REQUEST_TIMESTAMP_MISSING("400009"),
    /**
     * 请求时间戳格式错误
     */
    REQUEST_TIMESTAMP_FORMAT_INVALID("400010"),
    /**
     * 请求时间戳非法
     */
    REQUEST_TIMESTAMP_ILLEGAL("400011"),
    /**
     * security key过期
     */
    SECURITY_KEY_EXPIRED("400012");
