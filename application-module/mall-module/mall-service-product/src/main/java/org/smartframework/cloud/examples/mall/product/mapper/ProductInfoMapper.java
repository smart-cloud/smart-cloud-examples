 ...
 */
package org.smartframework.cloud.examples.mall.product.mapper;
 ...
 */
@Mapper
public interface ProductInfoMapper extends SmartMapper<ProductInfoEntity> {
     ...
     * @return
     */
    int updateStock(@Param("list") List<UpdateStockReqDTO.UpdateStockItem> list);
