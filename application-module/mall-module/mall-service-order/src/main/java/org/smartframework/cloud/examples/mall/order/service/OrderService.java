 ...
 */
package org.smartframework.cloud.examples.mall.order.service;
...
import org.smartframework.cloud.examples.mall.order.repository.OrderBillRepository;
import org.smartframework.cloud.examples.mall.order.repository.OrderDeliveryInfoRepository;
import org.smartframework.cloud.examples.mall.order.constants.OrderReturnCodes;
import org.smartframework.cloud.examples.mall.order.entity.OrderBillEntity;
import org.smartframework.cloud.examples.mall.order.entity.OrderDeliveryInfoEntity;
...
public class OrderService {
    ...
    private final OrderDeliveryInfoService orderDeliveryInfoService;
    ...
    public void submit(SubmitOrderDTO submitOrderDTO) {
        ...
        if (orderBillRepository.getByOrderNo(orderNo) != null) {
        ...
        // 创建订单信息
        orderService.createOrder(orderNo, submitOrderDTO.getUid(), products, productInfos);

        // 扣减库存、抵扣优惠券、更新订单状态
        orderService.deductStockAndCounpon(orderNo, products);
    }
    ...
    public void deductStockAndCounpon(String orderNo, List<SubmitOrderProductInfoReqVO> products) {
        ...
        orderBillRepository.updateStatus(orderNo, status);
    }
    ...
    public QuerySubmitResultRespVO querySubmitResult(String orderNo) {
        OrderBillEntity orderBillEntity = orderBillRepository.getByOrderNo(orderNo);
        ...
        List<OrderDeliveryInfoEntity> orderDeliveryInfoEntities = orderDeliveryInfoRepository.getByOrderNo(orderNo);
    ...
    private List<OrderDeliveryInfoEntity> saveOrderDeliveryInfo(String orderNo,
        ...
        orderDeliveryInfoService.create(entities);
    ...
    private OrderBillEntity saveOrderBill(String orderNo, Long userId, List<OrderDeliveryInfoEntity> entities) {
        ...
        orderBillRepository.create(orderBillEntity);
