 ...
 */
package org.smartframework.cloud.examples.basic.user.service;
...
public class LoginInfoService {
    ...
    public LoginRespVO login(LoginReqVO req) {
        LoginInfoEntity loginInfoEntity = loginInfoRepository.queryByUsername(req.getUsername());
        ...
        UserInfoEntity userInfoEntity = userInfoRepository.getById(loginInfoEntity.getUserId());
