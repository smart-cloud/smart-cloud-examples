...
import org.smartframework.cloud.examples.basic.auth.mapper.RoleInfoMapper;
...
@Repository
public class RoleInfoRepository extends BaseRepository<RoleInfoMapper, RoleInfoEntity> {
