...
import org.smartframework.cloud.examples.basic.auth.mapper.PermissionInfoMapper;
...
@Repository
public class PermissionInfoRepository extends BaseRepository<PermissionInfoMapper, PermissionInfoEntity> {
