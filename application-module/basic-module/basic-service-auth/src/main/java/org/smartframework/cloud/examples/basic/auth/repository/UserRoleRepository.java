...
import org.smartframework.cloud.examples.basic.auth.mapper.UserRoleRelaMapper;
...
public class UserRoleRepository extends BaseRepository<UserRoleRelaMapper, UserRoleRelaEntity> {
    ...
    public List<UserRoleRespVO> listRole(Long uid) {
        return getBaseMapper().listRole(uid);
    }
