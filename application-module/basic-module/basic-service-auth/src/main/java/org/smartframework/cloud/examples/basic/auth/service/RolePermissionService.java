...
public class RolePermissionService {
    ...
    public Boolean create(RolePermissonCreateReqVO req) {
        return rolePermissionRelaRepository.create(req.getRoleId(), req.getPermissonIds(), UserContext.getUserId());
    }
    ...
    public Boolean update(RolePermissonUpdateReqVO req) {
        rolePermissionRelaRepository.logicDelete(req.getRoleId());
        rolePermissionRelaRepository.create(req.getRoleId(), req.getPermissonIds(), UserContext.getUserId());
        return true;
    }
    ...
    public BasePageResponse<RolePermissionRespVO> page(PageRolePermissonReqVO req) {
        return rolePermissionRelaRepository.page(req);
    }
