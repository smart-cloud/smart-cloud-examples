...
public class UserRoleService {
    ...
    public Boolean create(UserRoleCreateReqVO req) {
        return userRoleRepository.create(req.getUid(), req.getRoleIds(), UserContext.getUserId());
    }
    ...
    public Boolean update(UserRoleUpdateReqVO req) {
        userRoleRepository.logicDelete(req.getUid());
        userRoleRepository.create(req.getUid(), req.getRoleIds(), UserContext.getUserId());
        return true;
    }
    ...
    public List<UserRoleRespVO> listRole(Long uid) {
        return userRoleRepository.listRole(uid);
    }
