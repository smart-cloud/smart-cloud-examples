...
public class RoleInfoService {
    ...
    public Boolean create(RoleCreateReqVO req) {
        if (roleInfoRepository.exist(req.getCode())) {
            throw new DataValidateException(AuthReturnCodes.ROLE_CODE_EXIST);
        }
        return roleInfoRepository.create(req);
    }
    ...
    public Boolean update(RoleUpdateReqVO req) {
        ...
        return roleInfoRepository.update(req);
    }
    ...
    public Boolean logicDelete(Long id) {
        return roleInfoRepository.logicDelete(id, UserContext.getUserId());
    }
