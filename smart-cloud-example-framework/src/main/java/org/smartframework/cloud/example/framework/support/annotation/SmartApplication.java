...
@Documented
@Inherited
@SmartSpringCloudApplication(componentBasePackages = "org.smartframework.cloud.example", feignClientBasePackages = "org.smartframework.cloud.example.*.service.rpc")
